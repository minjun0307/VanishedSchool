...
// 로드 패널: ScrollView에 슬롯 4개를 생성하고, 클릭하면 해당 번호 파일에서 불러옵니다.
public class LoadP : MonoBehaviour
{
    public SaveSlot m_SlotPrefab;          // 슬롯 프리팹 (Button + Text) — 세이브와 같은 프리팹 사용
    public Transform m_Content;            // ScrollView > Viewport > Content
    public string m_LabelPrefix = "Load";  // 슬롯 텍스트 앞부분 → "Load 1" ~ "Load 4"
